...
void __attribute__((noreturn)) Task_2_Function(void)
{
    while (1)
	{
		for(u32 Counter=0;Counter<9000;Counter++){MCAL_GPIO_Write_Pin(GPIO_B,Pin_6,HI);}
	}
}
/****************************************/
void __attribute__((noreturn)) Task_3_Function(void)
{
	while (1)
	{
		for(u32 Counter=0;Counter<9000;Counter++){MCAL_GPIO_Write_Pin(GPIO_B,Pin_7,HI);}
	}
}
/****************************************/
...
*****************************************/
/*Create Tasks Data*/
static RTOS_Task_t Task_1={1,"Task_1",128,Task_1_Function};
static RTOS_Task_t Task_2={2,"Task_2",128,Task_2_Function};
static RTOS_Task_t Task_3={3,"Task_3",128,&Task_3_Function};
/****************************************/
int main(void) 
{
	/*Configure Required Hardware*/
...
void  __attribute__((noreturn)) Task_1_Function(void)
{
	while (1)
	{
		for(u32 Counter=0;Counter<500;Counter++){MCAL_GPIO_Write_Pin(GPIO_A,Pin_2,HI);}
		RTOS_Delay(1000);
	}
}
/****************************************/
void __attribute__((noreturn)) Task_2_Function(void)
{
    while (1)
	{
        for(u32 Counter=0;Counter<1000;Counter++){MCAL_GPIO_Write_Pin(GPIO_B,Pin_6,HI);}
        RTOS_Delay(1500);
	}
}
/****************************************/
void __attribute__((noreturn)) Task_3_Function(void)
{
	while (1)
	{
        for(u32 Counter=0;Counter<1500;Counter++){MCAL_GPIO_Write_Pin(GPIO_B,Pin_7,HI);}
        RTOS_Delay(2000);
	}
}
/****************************************/
