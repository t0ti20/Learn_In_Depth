...
typedef enum GPIO_Pin_Mode_t
{
     ...
     Alternate_Input                    =(u8)(4),      /*Alternate function output Open-drain*/
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Lock_Pin(GPIOX_t *Port,GPIO_Pin_Number_t Pin);
/********************************************************************
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Initialize(GPIOX_t *Port,GPIO_Pin_Config_t Pin);
...
********************************************************************/
u8 MCAL_GPIO_Read_Pin(GPIOX_t *Port,GPIO_Pin_Number_t Pin);
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Write_Pin(GPIOX_t *Port,GPIO_Pin_Number_t Pin,u8 State);
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Toggle_Pin(GPIOX_t *Port,GPIO_Pin_Number_t Pin);
...
********************************************************************/
u16 MCAL_GPIO_Read_Port(GPIOX_t *Port);
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Write_Port(GPIOX_t *Port,u16 Value);
...
* Return value:   : Void
********************************************************************/
void MCAL_GPIO_Toggle_Port(GPIOX_t *Port);
