...
#if LCD_MODE == Eight_Bit_Mode
     /*Write Data*/
     for(Pin_Counter=Pin_0;Pin_Counter<Pin_8;Pin_Counter++)MCAL_GPIO_Write_Pin(LCD_Data_Port,Pins[Pin_Counter],((Data>>Pin_Counter)&ONE));
#elif LCD_MODE == Four_Bit_Mode
#endif 
     MCAL_GPIO_Write_Pin(LCD_Control_Port,LCD_EN,HI);            /*Wait For LCD*/
     delay_ms(5)                                                 /*Wait For LCD*/
...
* Return value:   : Void
********************************************************************/
static void itoa(u32 Data,u8 String[])
{
     u8 Digit=ZERO,Count;
...
* Return value:   : Void
********************************************************************/
static void ftoa(f32 Data,u8 String[])
{
     u8 Digit,Count;
...
* Return value:   : Void
********************************************************************/
void HAL_LCD_Send_String(const s8 String[])
{
     while(*String)
     {
