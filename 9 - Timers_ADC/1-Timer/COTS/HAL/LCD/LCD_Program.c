...
----------    GLOBAL DATA     ------------
*****************************************/
// u8 LCD_VidRead_Data(u8 Location)
// {
// 	u8 Data;
// 	DIO_VidSet_Pin_Value(LCD_CTRL_PORT,LCD_RS_PIN,HI);							/*SET RS PIN AS LOW*/
// 	DIO_VidSet_Pin_Value(LCD_CTRL_PORT,LCD_RW_PIN,HI);							/*SET RW PIN AS LOW TO WRITE*/
// #if LCD_Mode == Mode_8
