...
void MCAL_GPIO_Initialize(GPIO_Port_t Port_Number,GPIO_Pin_Config_t Pin)
{
	...
	Register_t volatile *Configure_Register=NULL;
     switch (Port_Number)
     {
          case GPIO_A:RCC_Pheripheral_Enable(APB2ENR,IOPAEN);Port=&GPIOA;break;
          case GPIO_B:RCC_Pheripheral_Enable(APB2ENR,IOPBEN);Port=&GPIOB;break;
          case GPIO_C:RCC_Pheripheral_Enable(APB2ENR,IOPCEN);Port=&GPIOC;break;
          case GPIO_D:RCC_Pheripheral_Enable(APB2ENR,IOPDEN);Port=&GPIOD;break;
     }
